...
from model.utils import msg6e_init_pose, msg6e_goal_point
...
class StageWorld():
    ...
    def generate_goal_point(self):
        self.goal_point = msg6e_goal_point(self.index)
        self.pre_distance = 0
    ...
    def get_reward_and_terminate(self, t):
        ...
        #reward_g = (self.pre_distance - self.distance) * 5
        reward_g = (self.pre_distance - self.distance) * 2.5
        reward_c = 0
        reward_w = 0
        result = 0
    ...
    def reset_pose(self):
        ...
        reset_pose = msg6e_init_pose(self.index)
