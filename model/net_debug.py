...
class ControlActor(nn.Module):
    def __init__(self, msg_action_space, ctr_action_space):
        super(ControlActor, self).__init__()
        self.act_fc1 = nn.Linear(4*msg_action_space, 64)
...
class CNNPolicy(nn.Module):
	...
	self.n_agent = n_agent
        ...
        self.ctr_actor = ControlActor(msg_action_space, ctr_action_space)
